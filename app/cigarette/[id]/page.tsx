    ...
    <div className="max-w-5xl mx-auto pt-10 px-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 bg-[#080808] border border-zinc-900 p-10 rounded-sm shadow-2xl">
          ...
          <button className="w-full bg-[#FFB800] text-black font-black py-5 mt-12 uppercase tracking-widest hover:bg-white transition-all shadow-[0_0_20px_rgba(255,184,0,0.2)]">
            POST REVIEW
          </button>
        </div>
